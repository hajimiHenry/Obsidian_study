...
label("$x$", (2.02,-0.03,0), S, fontsize(16));
label("$y$", (-0.05,2.00,0), E, fontsize(16));
label("$z$", (0.16,0.10,H+0.28), E, fontsize(16));
...
label("$l\parallel z$", 0.5*(G0+G1)+(0.12,0.06,0.04), E, fontsize(15));

triple P = (R,0,0);
draw(O--P, deepgreen+1.5, arrow=Arrow3());
label("$R$", 0.5*P+(0.06,-0.06,0.04), S, fontsize(16));
dot(O, linewidth(6));
label("$O$", O, SW, fontsize(17));

label("$x^2+y^2=R^2$", (-1.15,-0.78,0.35), W, fontsize(16));
