...
![一维换元缩放因子示意图：u轴上的均匀刻度映射到x轴上后变得疏密不均，局部缩放倍数即为导数](images/1d_substitution.png)
...
![uv平面上的微元小矩形](images/uv_rectangle.png)
...
![从uv平面小矩形到xy平面平行四边形的映射对比](images/xy_parallelogram.png)
...
![极坐标映射的具体演示：从rho-theta平面的矩形到xy平面的切向与径向微元平行四边形](images/polar_jacobian_demo.png)
...
> 内层 $\int_0^a \rho e^{-\rho^2}d\rho$ 用的是一元积分里的**凑微分法**→ [[calculus/上学期内容/02_凑微分法_第一换元]]
